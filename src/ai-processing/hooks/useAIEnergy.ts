...
import { smartAlertService } from '@/ai-processing/services/smartAlertService';
import { energyOptimizerService } from '@/ai-processing/services/energyOptimizerService';
import { 
  ConsumptionInsight, 
  OptimizationPlan,
