...
import { useAIEnergy } from '@/ai-processing/hooks/useAIEnergy';
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-8">
            ...
            <Button onClick={generateOptimizationPlans}>
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        {optimizationPlans.map((plan, index) => (
          <div key={index} className="p-4 rounded-lg border border-muted bg-card">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="mb-3">
                  ...
                  <Progress value={Math.min(plan.estimatedSavings, 200) / 2} />
                </div>
                
                {plan.scheduleConfig && (
                  <div className="text-xs text-muted-foreground mb-3">
                    Agendado para: {plan.scheduleConfig.startTime} - {plan.scheduleConfig.endTime}
                ...
                <div className="mt-2">
                  ...
                  >
                    {plan.scheduleType === 'immediate' ? 'Aplicar Agora' : 'Agendar'}
                  </Button>
                </div>
              </div>
            </div>
